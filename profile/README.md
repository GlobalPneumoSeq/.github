...
| PopPUNK GPS Database   | Database v10 ([.zip](https://gps-project.cog.sanger.ac.uk/GPS_v10.zip) or [.tar.gz](https://gps-project.cog.sanger.ac.uk/GPS_v10.tar.gz))<br>[GPSC designation v10](https://gps-project.cog.sanger.ac.uk/GPS_v10_external_clusters.csv) | The latest [PopPUNK](https://poppunk-docs.bacpop.org/) database to assign [Global Pneumococcal Sequence Cluster (GPSC)](https://www.pneumogen.net/gps/#/gpsc) |
